...
pub fn register_format_functions() -> Vec<Arc<dyn ComputeFunction>> {
    ...
    // 9 functions from format_detect
    ...
    // 16 functions from format_config
    ...
    // 20 functions from format_archive
    ...
    // 9 functions from format_erasure
    ...
    // 19 functions from format_serialization
    ...
    // 18 functions from format_columnar
    ...
    // 18 functions from format_image
    ...
    // 23 functions from format_document
    ...
    // 16 functions from format_audio
    ...
    // 13 functions from format_scientific
    ...
    // 10 functions from format_database
    ...
    // 8 functions from format_network
    ...
    // 13 functions from format_binary
